...
if (defined("CLASS_PS_SOURCE_TF2_PHP")) return 1;
define("CLASS_PS_SOURCE_TF2_PHP", 1);

include_once(rtrim(dirname(__DIR__), '/\\') . '/source.php');

class PS_source_tf2 extends PS_source {

var $class = 'PS::source::tf2';
var $use_roles = true;
